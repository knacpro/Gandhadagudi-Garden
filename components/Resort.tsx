...
// ✅ Renamed from "Resort" to "resortActivities"
const resortActivities = [
  {
    id: 1,
    title: "Gym",
    image: "/images/gym2.png?height=400&width=500",
    description:
  ...
  },
  {
    id: 2,
    title: "Garadi Mane",
    image: "/images/gardi10.png?height=400&width=500",
    description:
      "Garadi Mane is a traditional Indian gymnasium where warriors once trained in wrestling and martial arts, preserving age-old physical culture and discipline.",
  },
  {
    id: 3,
    title: "Bird Watching",
    image: "/images/birds8.png?height=400&width=500",
    description:
  ...
  },
  {
    id: 4,
    title: "Horse Riding",
    image: "/images/hourse6.png?height=400&width=500",
    description:
  ...
  },
  {
    id: 5,
    title: "Swimming",
    image: "/images/swing9.png?height=400&width=500",
    description:
  ...
  },
  {
    id: 7,
    title: "Boat Riding",
    image: "/images/boat10.png?height=400&width=500",
    description:
  ...
  },
  {
    ...
    image: "/images/kaya2.png?height=400&width=500",
    description:
  ...
  },
  {
    id: 9,
    title: "Rain Dance",
    image: "/images/rain8.png?height=400&width=500",
    description:
  ...
  },
  {
    id: 11,
    title: "Tree House",
    image: "/images/teerhouse1.png?height=400&width=500",
    description:
  ...
  },
  {
    id: 12,
    title: "Zip Line",
    image: "/images/zipline8.png?height=400&width=500",
    description:
...
export default function ResortActivitiesComponent() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      <h3 className="text-[#8BAD2B] text-lg font-medium tracking-wide">
        ENJOY ULTIMATE ALPINE EXPERIENCES
      </h3>

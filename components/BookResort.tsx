        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row gap-8">
            <div className="md:w-1/2">
              <h5 className="text-[#8CBF1E] uppercase text-sm font-medium">BOOK NOW</h5>
              <h2 className="text-3xl font-bold mt-2">BOOK RESORT NOW</h2>
              <p className="mt-4">
                For those looking for value, we offer the cheapest GandhadaGudi Garden Packages without compromising on quality.
                Immerse yourself in the natural beauty and comfort that only GandhadaGudi Garden GandhadaGudi Garden can provide.
              </p>

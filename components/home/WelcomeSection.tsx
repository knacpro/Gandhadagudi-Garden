        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-12 flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1 flex flex-col justify-center">
              ...
              <p className="text-[#333333] mb-12 leading-relaxed">
                ...
                in the heart of Byahatti lush jungles, we offer a one of a kind experience with our exclusive Gandhadagudi Garden
                and custom made Packages to suit every traveller. Whether you&apos;re seeking adventure at our
                Byahatti Gandhadagudi Garden, or relaxation at our Best Byahatti Swimming Pool Resort, Gandhadagudi luxury garden has
                it all.
              </p>
